...
-- Insert sample assessment data for Barbara Robinson using valid assessment types
...
-- Baseline start of care assessment
(
  '418a353a-cc2b-401b-a403-73148307f4d5',
  ...
  2, -- ambulation
  4, -- medication_mgmt
  'Baseline start of care assessment. Patient requires assistance with mobility and transferring due to chronic kidney disease complications.',
  NULL
),
-- Mid-episode follow up assessment
(
  '418a353a-cc2b-401b-a403-73148307f4d5',
  (SELECT id FROM public.episodes WHERE patient_id = '418a353a-cc2b-401b-a403-73148307f4d5' LIMIT 1),
  'follow_up',
  ...
  4, -- medication_mgmt
  'Follow-up assessment. Patient showing improvement in ambulation after PT interventions. Some decline noted in bathing and toileting independence.',
  NULL
),
...
(
  ...
  3, -- ambulation
  4, -- medication_mgmt
  'Latest follow-up assessment shows continued bathing challenges. Recommend adaptive equipment and safety modifications. Good progress with transferring skills.',
  NULL
);

-- Insert sample interventions for scheduling
