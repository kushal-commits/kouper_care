-- Create some basic profiles for the system to work
INSERT INTO profiles (id, email, full_name, role) VALUES 
(gen_random_uuid(), 'nurse1@example.com', 'Sarah Mitchell', 'nurse'),
(gen_random_uuid(), 'coordinator1@example.com', 'Dr. James Wilson', 'clinical_coordinator'),
...
SET 
  ...
  coordinator_id = (SELECT id FROM profiles WHERE role = 'clinical_coordinator' LIMIT 1)
WHERE patient_id = '061a562c-e34d-4c2b-b36d-3d02465de7b2';

-- Update assessments to have proper assessor assignments  
UPDATE assessments 
SET assessor_id = (SELECT id FROM profiles WHERE role IN ('nurse', 'clinical_coordinator') ORDER BY random() LIMIT 1)
